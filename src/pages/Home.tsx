    ...
    <div>
      ...
      <section className="relative bg-gold overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 pt-12 pb-16 lg:pt-16 lg:pb-24 grid lg:grid-cols-12 gap-8 items-center min-h-[80vh]">
          {/* Left: Real brand poster photography */}
          <div className="lg:col-span-5 relative reveal d-1">
            <div className="relative max-w-[420px] mx-auto">
              <img
                src="/poster-because-hero.png"
                alt="Because Your Hair Is The Crown — Luxury Wig City"
                className="w-full h-auto rounded-sm shadow-luxe object-cover"
                style={{ aspectRatio: '2/3' }}
              />
              {/* Gold overlay badge */}
              <div className="absolute top-4 left-4 bg-burgundy/90 backdrop-blur-sm text-gold px-3 py-1.5 rounded text-[10px] tracking-[0.2em] uppercase font-bold">
                ✦ Luxury Wig City
              </div>
            </div>
          </div>

        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-12 grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-8 space-y-10">
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Field label="Full Name *" value={form.name} onChange={handle('name')} placeholder="Precious Okoh" required />
                <Field label="Phone *" value={form.phone} onChange={handle('phone')} placeholder="+234 800 000 0000" required />
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Field label="Address *" value={form.address} onChange={handle('address')} placeholder="Plot 123, Wuse 2" wide required />
                <div>
          ...
          <aside className="lg:col-span-4">
            <div className="bg-pearl p-8 rounded-sm sticky top-32">
              ...
              <Button type="submit" variant="primary" size="lg" fullWidth disabled={createOrder.isPending || cartItems.length === 0}>
...
}> = ({ label, value, onChange, placeholder, wide, required }) => (

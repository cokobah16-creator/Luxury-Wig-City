      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-12 grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8">
          ...
          <p className="mt-4 text-xs text-burgundy/50 leading-relaxed">
            <strong>Disclaimer:</strong> AI rendering is a preview only. Actual wig appearance depends on installation, your face shape, and lighting. For accurate fitting, book a consultation at our showroom.
          </p>
        </div>

...
/**
 * Luxury Wig City medallion mascot.
 * Recreated as SVG from Precious's brand identity guide:
 * stylized woman with feathered/leaf hair frames, eyelashes, in a circle.
 */
export const Logo: React.FC<LogoProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* HAIR — feathered/leaf hair frames LEFT */}
      ...
      {/* HAIR — feathered/leaf hair frames RIGHT */}
